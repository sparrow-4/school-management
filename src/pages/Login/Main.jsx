...
<label className="block text-sm font-semibold text-slate-700 " for="role">Select Your Role</label>
...
{/*mail*/}
<div className="space-y-2">
<label className="block text-sm font-semibold text-slate-700 " for="email">College Email</label>
<div className="relative">
<IoMailOutline className='absolute left-3 top-1/2 -translate-y-1/2 text-slate-400 text-lg' />
<input className="w-full pl-10 pr-4 py-3 bg-slate-50  border border-slate-200  rounded-lg focus:ring-2 focus:ring-black/10 focus:border-primary outline-none transition-all text-slate-900  placeholder:text-slate-400" id="email" name="email" placeholder="e.g. student@college.edu" type="email"/>
</div>
</div>
...
<label className="block text-sm font-semibold text-slate-700 " for="password">Password</label>
