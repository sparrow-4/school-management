...
return (
  ...
  if (role === "admin") navigate("/otp", { replace: true });
            ...
            >
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input
                    className="w-full pl-10 pr-4 py-3 bg-slate-50  border border-slate-200  rounded-lg focus:ring-2 focus:ring-black/10
                                     focus:border-primary outline-none transition-all text-slate-900  placeholder:text-slate-400"
                    id="email"
                    name="email"
 ...
 hover:text-white hover:text-2xl text-black font-bold py-3.5 px-4
  ...
  active:scale-[0.98] flex items-center justify-center gap-2 mt-4"
                type="submit"
              >
                <span>Sign In</span>
