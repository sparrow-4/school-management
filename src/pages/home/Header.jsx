      ...
      <div  className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="bg-primary text-black px-8 py-4 rounded-xl text-lg font-bold shadow-lg shadow-primary/20 hover:scale-105 transition-transform  hover:bg-blue-600 hover:text-amber-50 ">
              View Events
            </button>
            <button className="bg-primary text-black px-8 py-4 rounded-xl text-lg font-bold shadow-lg shadow-primary/20 hover:scale-105 transition-transform  hover:bg-blue-600 hover:text-amber-50 ">
              Submit Event
